...
module.exports = {
  ...
  before: function (scope, cb) {
    ...
    //
    // e.g. if someone runs:
    // $ sails generate humpback-api user find create update
...
function INVALID_SCOPE_VARIABLE (varname, details, message) {
  var DEFAULT_MESSAGE =
  'Issue encountered in generator "humpback-api":\n'+
  'Missing required scope variable: `%s`"\n' +
  'If you are the author of `sails-generate-humpback-api`, please resolve this '+
